...
// Placeholder Avatar - Use the standard <img> tag for better optimization in Next.js
const TeamAvatar = ({ src, alt }) => (
  // We'll use the <img> tag directly, which is better for accessibility and modern Next.js apps
...
// --- NOTE: Update these 'img' paths to match the filenames in your public folder ---
const teamMembers = [
  {
    name: "Jay Pawar", 
    role: "Founder & CEO",
    href: "https://www.linkedin.com/in/jay-pawar-b68589273/",
    href2: "https://x.com/JAY_Pawar_20",
    // Example: If the file is public/images/jay.jpg
    img: "/photos/my img.png", // <--- Public Folder Path
  },
  {
    name: "Manish Sharma",
    role: "CTO",
  ...
  },
  {
    ...
    href: "https://www.linkedin.com/in/abhishek-gayakwad-44b769222?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
    href2: "https://x.com/AbhishekGayakwad",
    // Example: If the file is public/images/abhishek.jpg
    img: "/photos/AbhishekImg.jpeg", // <--- Public Folder Path
  },
];
// -----------------------------------------------------------------------------------
    ...
    <section className="relative w-full py-20 sm:py-28 overflow-hidden bg-white">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            At ByteWings, our expert team is driven by passion and purpose — transforming your ideas into powerful digital experiences.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {teamMembers.map((member) => (
            <div
              ...
              className="bg-gray-50/50 p-8 rounded-xl shadow-lg border border-gray-100 text-center"
            >
              {/* Using the updated TeamAvatar component */}
              ...
              <div className="flex justify-center space-x-4">
                ...
                {member.href && (
                  <a href={member.href} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-800 transition-colors">
                    <Linkedin size={20} />
                  </a>
                )}
                {/* Check if href2 exists before rendering the link */}
                {member.href2 && (
                  <a href={member.href2} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-800 transition-colors">
                    <Twitter size={20} />
                  </a>
                )}
              </div>
